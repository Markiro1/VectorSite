...
namespace VectorSite.Util
{
    // TODO: Змінити та винести ключ в конф файл
    public class AuthenticationUtil
    {

        public static string GenerateJWTAuthentication(User user)
        {
            var claims = new List<Claim>
            {
                new Claim(JwtHeaderParameterNames.Jku, user.Name),
            ...
            var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(Convert.ToString(
        ...
        public static string ValidateToken(string token)
        {
            ...
            var key = Encoding.ASCII.GetBytes(Convert.ToString(
                ""
                ));
            ...
            try
            {
                ...
                var name = jwtToken.Claims.First(claim => claim.Type == "kid").Value;
